...
import small_management_program.controller.queries.MultipleQueries;
...
public class AlgorithmsBills {
    ...
    public boolean isPossible(BillingRepresentation billingRepresentation, int month){
        ...
        return !billingRepresentation.isMonthBilled(month);
    }
    ...
    public void createBill(BillingRepresentation billingRepresentation, boolean showAlert){
        ...
        if(!this.isPossible(billingRepresentation))
            return;
    ...
    public void createBill(BillingRepresentation billingRepresentation, int billingYear, int billingMonth, boolean showAlert){
        ...
        try{
            ControllerFacade.getInstance().executeQuery(createNewBill);
        }
